...
Agent
   └── begeniux/server      → LangGraph.js + Gemini 2.0 Flash
                               (or Anthropic Claude — set provider: "anthropic")
```
...
4. **API route**: keep the one-line handler. Swap to Anthropic if you prefer Claude.
